...
class HospitalParserTest {
    ...
    void hospitalParsing(){
        ...
        Hospital hostpital = hospitalParser.parse(this.line1);
        Assertions.assertEquals("A1120837",hostpital.getId());
        Assertions.assertEquals(address,hostpital.getAddress());
    }
}
// 유닛테스트는 위와 같은 기능 하나만 테스트
// 통합테스트는 전체 만든 코드를 테스트